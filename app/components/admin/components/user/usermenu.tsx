...
function UserMenu() {
  ...
  return (
    <div className=" m-4 p-2 bg-primary-100 text-primary-900  shadow-md flex flex-col items-center">
      <button
      ...
      <Clickoutside status={display} onClick={() => setDisplay(false)}>
        <div className="absolute left-0 bottom-full w-full mb-2 rounded-md shadow-lg">
          <div className="px-2 py-2 bg-primary-100 rounded-md shadow w-full">
            <button className="block w-full cursor-pointer px-4 py-2 text-sm font-semibold bg-transparent rounded-lg hover:text-primary-900 focus:text-primary-900 hover:bg-primary-200 focus:bg-primary-200 focus:outline-none focus:shadow-outline">
              My Profile
            </button>

...
const CustomTable: React.FC<CustomTableProps> = ({ data,onOptionChange ,pageIndex,pageSize, pageCount, setPagination,onTableDateRangeChange,options,columns}) => {
  ...
  const tableOptions=  [{label:"Today",value:"today"},{label:"Last 7 Days",value:"last7days"},{label:"Last 30 Days",value:"lastMonth"},];
...
<div className="flex w-full   justify-between gap-2 py-2 " >
         <div className="flex w-full flex-wrap  justify-start gap-2  ">
            <span className="flex">
            {onTableDateRangeChange &&<DateRangeComponent
                open={dateRangeModal}
        ...
        >
          {tableCol?.map((col) => (
            ...
            >
              ...
              <span className="block sm:hidden font-bold">{col.label}:</span>
...
<div className="flex flex-wrap justify-center items-center gap-2 mt-4 p-1">
        ...
        <span className="flex text-[#2C2E7B] items-center gap-1">Set page size:</span>
        <input
          type="number"
         // value={pageSize}

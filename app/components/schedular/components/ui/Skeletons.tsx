...
export const CalendarSkeleton = () => (
  <div className="w-full p-4 h-full overflow-y-clip">
    <div className="flex flex-col h-full">
      {/* Static gray blocks */}
      <div className="h-12 bg-primary-200 rounded-lg mb-4"></div>
      <div className="h-10 bg-primary-200 rounded-lg mb-2"></div>
      <div className="grid grid-cols-7 gap-1 mb-1">
        {[...Array(35)].map((_, i) => (
          <div key={i} className="h-16 bg-primary-200 rounded-md"></div>
        ))}
      </div>
    </div>
  </div>
